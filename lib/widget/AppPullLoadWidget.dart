...
class AppPullLoadWidget extends StatefulWidget {
  ...
  AppPullLoadWidget(this.control, this.itemBuilder, this.onRefresh, this.onLoadMore, {this.refreshKey});

  @override
  _AppPullLoadWidgetState createState() => _AppPullLoadWidgetState(this.control, this.itemBuilder, this.onRefresh, this.onLoadMore, this.refreshKey);
}
...
class _AppPullLoadWidgetState extends State<AppPullLoadWidget> {
  ...
  _AppPullLoadWidgetState(this.control, this.itemBuilder, this.onRefresh, this.onLoadMore, this.refreshKey);
     ...
     // height: MediaQuery.of(context).size.height - 100,
      child: new Column(
        ...
        children: <Widget>[
          ...
          Container(
            child: Text("暂无数据", style: AppConstant.normalText),
          ),
        ],
      ),
    );
